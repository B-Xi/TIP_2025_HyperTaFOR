...
data_path='/mnt/HDD/data/zwj/model_2/my_model/train_ocbs/'
...
with open('/mnt/HDD/data/zwj/model_2/my_model/data/TRIAN_META_DATA_imdb_ocbs_19.pickle', 'wb') as handle:
