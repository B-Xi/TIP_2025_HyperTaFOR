...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='trento', choices=['paviaU', 'trento','pavia'])
    parser.add_argument("-m", "--test_class_num", type=int, default=6, choices=[8, 6])
    ...
    parser.add_argument('--episodes', type=int, default=50, help='Number of training episodes', choices=[40, 50])
    ...
    parser.add_argument('--spectral_size', type=int, default=64)
...
def dataload(args):
    ...
    name='TRIAN_META_DATA_imdb_ocbs_'+patch+'_64.pickle'
...
def main(seed):
    ...
    with open('/mnt/HDD/data/zwj/model_2/my_model/result_trento.txt', 'a') as f:
        f.write('number ')
