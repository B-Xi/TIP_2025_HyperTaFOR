...
def parse_args():
    ...
    parser.add_argument("-z", "--test_lsample_num_per_class", type=int, default=1, help='5 4 3 2 1')
...
def main(seed):
    ...
    with open('/mnt/HDD/data/zwj/model_2/my_model/result_paviac.txt', 'a') as f:
        f.write('number ')
